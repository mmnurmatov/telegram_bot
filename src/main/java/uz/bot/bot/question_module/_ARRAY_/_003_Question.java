...
public class _003_Question {
    ...
    public String testUserMethod() {
        ...
        int r_1 = average(new int[]{4, 2, 0, 6, 22, 8, 1});
        ...
        int r_2 = average(new int[]{44, 1, 8});
        ...
        int r_3 = average(new int[]{4, 2, 5, 7, -1, 8, 12, 14, 8, 2});
    ...
    public static void main(String[] args) {
        // array berilgan
        // massive elementlarini o'rtacha qiymatlarini hisoblang
        // va return qiling
    ...
    public static QuestionDto getQuestion() {
        ...
        question.setQuestionContentHtml("Massive (array) berilgan.\n" +
                "massive elementlarini o'rtacha qiymatlarini hisoblang\n" +
                "va return qiling\n\n" +
                "<code>    public int average(int array[]) {\n" +
                "       \n" +
                "    }</code>");
