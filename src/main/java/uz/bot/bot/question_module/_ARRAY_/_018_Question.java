...
public class _018_Question {
    public int[] sortByDecreasing(int array[]) {
    ...
    public String testUserMethod() {
        ...
        int r_1[] = sortByDecreasing(new int[]{1, 2, 1, 6, 22, 8, 1});
        s += "Test 1  ({1, 2, 1, 6, 22, 8, 1})  Kelgan javob  ";
        if (r_1 != null && r_1.length == 7 && r_1[0] == 22 &&
                r_1[1] == 8 && r_1[2] == 6 && r_1[3] == 2 && r_1[6] == 1) {
        ...
        int r_2[] = sortByDecreasing(new int[]{44, 1, 8});
        s += "\nTest 2  ({44, 1, 8}) .  Kelgan javob ";
        if (r_2 != null && r_2.length == 3 && r_2[0] == 44 && r_2[1] == 8 && r_2[2] == 1) {
        ...
        int r_3[] = sortByDecreasing(new int[]{4, 2, 5, 7, 2, 8, 2, 14, 8, 2});
        s += "\nTest 3  ({4, 2, 5, 7, 2, 8, 2, 14, 8, 2}).  Kelgan javob ";
        if (r_3 != null && r_3.length == 10 && r_3[0] == 14 && r_3[1] == 8 && r_3[3] == 7 && r_3[6] == 2 && r_3[8] == 2 && r_3[9] == 2) {
    ...
    public static void main(String[] args) {
        //  array[] berilgan
        // shu massivni  elementlarini kamayish tartibida jo'ylashtiring (sort by decreasing (descending) )  qiling
        //
    ...
    public static QuestionDto getQuestion() {
        ...
        question.setQuestionContentHtml("int array[] berilgan.\n" +
                "Shu massivni  elementlarini kamayish tartibida jo'ylashtiring. " +
                "(sort by decreasing (descending) )\n" +
                "va hosil bo'lgan massivni ni return qiling\n" +
                "Namuna: [2,4,1,5]\n" +
                "Natija: [5,4,2,1]\n\n" +
                "<code>public int[] sortByDecreasing(int array[]) {\n" +
                "      \n" +
                "    }</code>");
