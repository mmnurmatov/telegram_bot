...
public class _006_Question {
    ...
    public String testUserMethod() {
        ...
        if (r_1 != null && r_1.length == 8 && r_1[7] == 2) {
        ...
        if (r_2 != null && r_2.length == 4 && r_2[3] == 0) {
        ...
        if (r_3 != null && r_3.length == 11 && r_3[10] == 15) {
        ...
        if (r_4 != null && r_4.length == 6 && r_4[5] == 4) {
    ...
    public static void main(String[] args) {
        // n, array[] berilgan
        // shu massiv ohiriga n ni jo'ylashtiring
