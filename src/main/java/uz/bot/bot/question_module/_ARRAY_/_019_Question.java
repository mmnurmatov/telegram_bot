...
public class _019_Question {
    ...
    public int min(int array[]) {
        ...
        // oldin massivni kamayish tartibida joylashtirib olamiz
        // demak eng kattasi 0 index da turgan bo'ladi
        // demak ikkinchi eng katta son  1 indexta turadi
        return array[1];
    }
    ...
    public static void main(String[] args) {
        // array berilgan
        // o'sha massivdagi eng katta ikkinchi  elementni toping
        // masalan [1,2,6,4,7,2]
        // eng kattasi 7
        // ikkinchi eng kattasi 6
    ...
    public static QuestionDto getQuestion() {
        ...
        question.setQuestionContentHtml("int array[] berilgan.\n" +
                ...
                "       \n" +
                "    }</code>");
        question.setTitle(" eng katta ikkinchi  element ?");
