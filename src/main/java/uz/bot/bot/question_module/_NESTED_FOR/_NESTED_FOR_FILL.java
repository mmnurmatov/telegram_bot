...
/**
 * Created by Bigman on 13.02.2018.
 */
public class _NESTED_FOR_FILL {
    ...
    public static void fill() {
        ...
        questionRepository.saveQuestion(_033_Question.getQuestion()); //< _033_
        questionRepository.saveQuestion(_034_Question.getQuestion()); //< _034_
        questionRepository.saveQuestion(_035_Question.getQuestion()); //< _035_
    }
